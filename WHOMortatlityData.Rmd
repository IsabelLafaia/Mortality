...
ggplot(na.omit(mortalityPop), aes(x = Year, y = Rate, colour = factor(Country))) +  geom_line(show.legend = T, shape = ".") + facet_wrap(~Cause,  ncol = 8)+ theme(legend.position = "bottom", axis.text.x = element_text(angle = -50, vjust =1, hjust = 0)) 
